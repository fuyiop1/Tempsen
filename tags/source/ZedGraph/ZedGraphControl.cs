...
*/
	...
	#region Fields: Temporary state variables
        ...
        public Point DragStartPt
        {
            get { return _dragStartPt; }
            set { _dragStartPt = value; }
        }
        private Point _dragEndPt;

        public Point DragEndPt
        {
            get { return _dragEndPt; }
            set { _dragEndPt = value; }
        }
        private bool _isPointsZoom = false;

        public bool IsPointsZoom
        {
            get { return _isPointsZoom; }
            set { _isPointsZoom = value; }
        }
