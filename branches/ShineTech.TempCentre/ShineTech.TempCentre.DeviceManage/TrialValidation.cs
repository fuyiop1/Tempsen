...
{
    public partial class TrialValidation : Form
    {
        TrialValidationUI m_Ui = new TrialValidationUI();
        public bool Validated { get; set; }
        public TrialValidation()
        {
            InitializeComponent();
        }

        private void TrialValidation_Load(object sender, EventArgs e)
        {
            this.Text = Common.FormTitle;
            lbTrialText.Text = "Your 30-day trial period is expired,please enter CD-Key to continue using TempCentre.";
            Validated = false;
            key1.Focus();
        }
