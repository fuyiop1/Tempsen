...
///CreateBy: wangfei
///CreateOn:9/9/2011 3:33:45 PM
///FileName:ITAGPDF
///</summary>
namespace ShineTech.TempCentre.BusinessFacade
{
    [Serializable]
    public class ITAGPDF :SuperDevice
    {
        #region override properity
        private string _ProductName = "ITAG-PDF";
        ...
        private string _DeviceName = "ITAG-PDF";
        public override string DeviceName
        {
            get { return _DeviceName; }
            set { _DeviceName = value; }
        }
        private int _DeviceID = (int)DeviceType.ITAGPDF;
